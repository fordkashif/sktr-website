...
const revealX = (x: number, delay = 0) => ({
  initial: { opacity: 0, x },
...
export default function AthleticsPage({ vertical: v }: { vertical: Vertical }) {
  ...
  const midTextY = useTransform(midScroll, [0, 1], ["12%", "-12%"]);
  ...
  return (
    <>
      ...
      <main className="w-full max-w-[1700px] mx-auto px-4 sm:px-8 pb-24">
        ...
        <motion.div
          ...
          {credentialItems.map((item, i) => (
            <motion.div
              ...
              {i > 0 && (
                <motion.span
                  className="text-[rgba(131,145,190,0.2)] hidden sm:block"
                  variants={{
        ...
        {/* ── Mission statement ── */}
        <div className="mt-20 pb-16 border-b border-[rgba(131,145,190,0.15)]">
          <motion.div
          ...
          <motion.div
            ...
            style={{ width: "clamp(3rem, 6vw, 5rem)" }}
          />
          <motion.h2
        ...
        {/* ── Pillars ── */}
        <div ref={pillarsRef} className="relative flex flex-col mt-2">
          ...
          {v.pillars.map((pillar, i) => (
            <motion.div
              ...
              <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true, amount: 0.1 }}
                transition={{ duration: 0.55, delay: i * 0.12 + 0.18, ease }}>
              ...
              <motion.p
                ...
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true, amount: 0.1 }}
                transition={{ duration: 0.55, delay: i * 0.12 + 0.28, ease }}>
                {pillar.body}
              </motion.p>
            </motion.div>
          ))}
          ...
          <div className="pb-12 border-b border-[rgba(86,118,255,0.2)]">
            ...
            <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
              ...
              <motion.p
                ...
                The operating platform built for SKTR Athletics — connecting coaches and their teams with individual athletes through one intelligent system.
              </motion.p>
            </div>
          </div>
            ...
            <motion.div
              ...
              <motion.div
                ...
                <p className="m-0 text-[rgba(232,235,240,0.48)] leading-relaxed" style={{ fontSize: "0.84rem" }}>
                  Set regimes, assess performance, track every athlete. Your team signs in to your squad on the app.
                </p>
              </motion.div>
            </motion.div>

            {/* Athlete — mobile mockup */}
            <motion.div
              ...
              <motion.div
                ...
                <p className="m-0 text-[rgba(232,235,240,0.48)] leading-relaxed mb-5" style={{ fontSize: "0.84rem" }}>
                  Whether on a coached team or working directly with SKTR Athletics — history, metrics, and growth on iOS and Android.
                </p>
              ...
              <motion.div
                ...
                <p className="m-0 text-[rgba(232,235,240,0.52)] max-w-[38rem]" style={{ fontSize: "0.95rem", lineHeight: "1.75" }}>
                  {role === "coach"
                    ...
                    : "You're on the early access list. We'll notify you as soon as SKTR Coach hits the App Store and Google Play."}
                </p>
              </motion.div>
            ) : (
              <div className="p-8 sm:p-12">
                <p className="mono text-blue mb-5" style={{ fontSize: "0.62rem", letterSpacing: "0.2em" }}>EARLY ACCESS</p>
                  ...
                  {([
                    {
                      ...
                      sub: "Web platform — manage athletes, assign regimes, track squad performance.",
                      platform: "Web Interface",
                    },
                    {
                      value: "athlete" as const,
                      label: "I'm an individual athlete",
                      sub: "Mobile app — for athletes working directly with SKTR Athletics, outside of a coached team.",
                      platform: null,
                    },
                  ]).map((opt) => (
                    <motion.button
                ...
                <motion.h3
                  ...
                  {role === "coach" ? "Get your team on SKTR Coach." : "Join SKTR Athletics."}
                </motion.h3>
                ...
                <form onSubmit={handleWaitlist} className="flex flex-col gap-4">
                  ...
                  <div className="flex items-center gap-4 flex-wrap">
                    <motion.button
                      ...
                      whileTap={{ scale: 0.97 }}
                      transition={{ type: "spring", stiffness: 400, damping: 22 }}>
                      {formStatus === "loading" ? "Sending…" : role === "coach" ? "Request platform access" : "Join the waitlist"}
                    </motion.button>
                    {formStatus === "error" && (
                      <motion.p
