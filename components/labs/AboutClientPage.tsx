      ...
      <main className="w-full">
          ...
          <div className="absolute inset-0 flex flex-col justify-end">
            <div className={`${cx} pb-14 sm:pb-16`}>
              ...
              <motion.div className="mt-6 border-l-2 border-[rgba(62,105,255,0.45)] pl-5 max-w-[42rem]" initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2, ease: ease }}>
                <p className="m-0 text-[rgba(232,235,240,0.55)] leading-[1.65] italic" style={{ fontSize: "clamp(0.95rem, 1.2vw, 1.05rem)" }}>
        ...
        <div className={cx}>
          ...
          <motion.section className="mt-16 grid grid-cols-1 lg:grid-cols-[1fr_1.3fr] gap-10 lg:gap-24" initial={{ opacity: 0, y: 28 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.2 }} transition={{ duration: 0.7, ease: ease }}>
            <div>
              <p className="mono text-[rgba(232,235,240,0.38)] mb-5" style={{ fontSize: "0.64rem", letterSpacing: "0.14em" }}>Who we are</p>
            ...
            <div className="flex flex-col gap-5 text-[rgba(232,235,240,0.7)] leading-[1.85]" style={{ fontSize: "clamp(0.95rem, 1.2vw, 1.05rem)" }}>
          ...
          <motion.section className="mt-16 grid grid-cols-1 lg:grid-cols-[1fr_1.3fr] gap-10 lg:gap-24 items-start" initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.2 }} transition={{ duration: 0.7, ease: ease }}>
            <div>
              <p className="mono text-[rgba(232,235,240,0.38)] mb-5" style={{ fontSize: "0.64rem", letterSpacing: "0.14em" }}>Studio profile</p>
            </div>
            <div className="border border-[rgba(131,145,190,0.14)]">
              {studioFacts.map(({ label, value }, i) => (
                <motion.div key={label} className="flex items-center justify-between px-6 py-4 border-b border-[rgba(131,145,190,0.08)] last:border-b-0" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ delay: i * 0.06, duration: 0.4 }}>
                  <span className="mono text-[rgba(232,235,240,0.36)]" style={{ fontSize: "0.6rem", letterSpacing: "0.1em" }}>{label}</span>
                  <span className="font-semibold text-[rgba(232,235,240,0.78)]" style={{ fontSize: "0.9rem" }}>{value}</span>
                </motion.div>
              ))}
            </div>
          </motion.section>
          ...
          <motion.section className="mt-20" initial={{ opacity: 0, y: 28 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.15 }} transition={{ duration: 0.7, ease: ease }}>
            <div className="mb-10">
              <p className="mono text-[rgba(232,235,240,0.38)] mb-[0.3rem]" style={{ fontSize: "0.64rem", letterSpacing: "0.14em" }}>How we work</p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-px border border-[rgba(131,145,190,0.14)] bg-[rgba(131,145,190,0.1)]">
              {values.map((v, i) => (
                <motion.div key={v.title} className="p-8 sm:p-10 bg-card flex flex-col gap-4" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.2 }} transition={{ duration: 0.55, delay: i * 0.07, ease: ease }}>
                  ...
                  <p className="m-0 text-[rgba(232,235,240,0.6)] leading-[1.78]" style={{ fontSize: "0.9rem" }}>{v.desc}</p>
                </motion.div>
              ))}
            </div>
          </motion.section>
          ...
          {/* SKTR Group */}
          <motion.section className="mt-16 border border-[rgba(131,145,190,0.14)] bg-card p-8 sm:p-10" initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.3 }} transition={{ duration: 0.7, ease: ease }}>
            <p className="mono text-[rgba(232,235,240,0.36)] mb-5" style={{ fontSize: "0.62rem", letterSpacing: "0.14em" }}>Part of SKTR Group</p>
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.4fr] gap-8 lg:gap-20">
              ...
              <p className="m-0 text-[rgba(232,235,240,0.6)] leading-[1.8]" style={{ fontSize: "0.95rem" }}>Labs sits within the broader SKTR group, alongside Athletics, Media, and Ventures. These verticals are in different stages of development — Labs is the working product. The group is built for the long term, not for a quick exit.</p>
            </div>
          </motion.section>
          ...
          <motion.section className="mt-20 mb-4" initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.4 }} transition={{ duration: 0.7, ease: ease }}>
            <div className="border border-[rgba(62,105,255,0.28)] px-8 sm:px-14 py-14 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-8">
              <div>
                ...
                <p className="mt-3 m-0 text-[rgba(232,235,240,0.56)]" style={{ fontSize: "0.95rem" }}>Reach us at <a href="mailto:signal@thesktr.com" className="text-blue hover:underline">signal@thesktr.com</a> or fill out the project form.</p>
              </div>
